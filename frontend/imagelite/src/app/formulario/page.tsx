...
import { InputText, Template, Button, RenderIfComponent, useNotification, FieldError, AuthenticatedPage } from '@/components'
                        ...
                        <div className='mt-5 grid grid-cols-1'>
                            ...
                            <div className='mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10'>
                                <div className='text-center'>
                                    ...
                                    <RenderIfComponent condition={!imagePreview}>
                                    ...
                                    <RenderIfComponent condition={!!imagePreview}>
                                        <img src={imagePreview} width={250} className='rounded-md'></img>
                                    </RenderIfComponent>
