    ...
    return (
        <>
            ...
            <div className={`${loading ? 'animate-pulse' : ''} container mx-auto mt-8 px-4`}>
                <RenderIfComponent condition={loading}>
...
export const RenderIfComponent: React.FC<RenderIfProps> = ({ condition = true, children }) => {
    ...
    return(
        <header className="bg-indigo-950 text-white py-3">
            <div className="container mx-auto flex justify-between items-center px-4">
                ...
                <RenderIfComponent condition={!!user}>
    ...
    return(
        <footer className="bg-indigo-950 text-white py-4 mt-8">
            <div className="container mx-auto text-center">
                Desenvolvido por Leonardo Calheiros
            </div>
        </footer>
    )
}